       ...
       <x-table>
          ...
          @forelse ($ventas as $venta)
              ...
              <tr>
                ...
                <td>{{$venta->fecha}}</td>
                <td>
                    <a href="{{route('sales.invoice',$venta)}}" class="btn bg-navy btn-sm" title="Generar PDF" target="_blank">
                ...
                <td>
                    <a href="#" wire:click='edit({{$venta->id}})' class="btn btn-primary btn-sm" title="Editar">
                        <i class="far fa-edit"></i>
                    </a>
                </td>
                <td>
                    <a wire:click="$dispatch('delete',{id: {{$venta->id}}, eventName:'destroySale'})" class="btn btn-danger btn-sm" title="Eliminar">
