...
<?php $component->withAttributes([]); ?>
          ...
          <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              ...
              <tr>
                ...
                <td>
                    <a href="<?php echo e(route('sales.invoice',$venta)); ?>" class="btn bg-navy btn-sm" title="Generar PDF" target="_blank">
                ...
                <td>
                    <a href="#" wire:click='edit(<?php echo e($venta->id); ?>)' class="btn btn-primary btn-sm" title="Editar">
                        <i class="far fa-edit"></i>
                    </a>
                </td>
                <td>
                    <a wire:click="$dispatch('delete',{id: <?php echo e($venta->id); ?>, eventName:'destroySale'})" class="btn btn-danger btn-sm" title="Eliminar">
...
<?php /**PATH /var/www/testapp/resources/views/livewire/sale/salelist.blade.php ENDPATH**/ ?>