<div class="row">
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-purple">
            <div class="inner">
                <h3><?php echo e($totalventasHoy); ?></h3>
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
            <div class="inner">
                <h3><?php echo e($totalventasMes); ?></h3>
...
<?php /**PATH /var/www/html/laravel/testapp/resources/views/home/row-cards-sales.blade.php ENDPATH**/ ?>