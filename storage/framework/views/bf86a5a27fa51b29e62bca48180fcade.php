        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('clients.show',$venta->clientes)); ?>" class="btn btn-primary btn-block"><b>Ver</b></a>
                </div>
                <!-- /.card-body -->
            </div>
...
<?php /**PATH /var/www/testapp/resources/views/livewire/sale/sale-show.blade.php ENDPATH**/ ?>