...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['cardTitle' => 'Datos tienda']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['cardTitle' => 'Datos tienda']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['item' => $shop]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['item' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shop)]); ?>
...
<?php endif; ?>
                        ...
                        <td><?php echo e($shop->nombre); ?></td>
                        <td><?php echo e($shop->slogan); ?></td>
                        <td><?php echo e($shop->telefono); ?></td>
                        <td><?php echo e($shop->email); ?></td>
                        <td><?php echo e($shop->direccion); ?></td>
                        <td><?php echo e($shop->ciudad); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['modalId' => 'modalShop','modalTitle' => 'Datos tienda','modalSize' => 'modal-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['modalId' => 'modalShop','modalTitle' => 'Datos tienda','modalSize' => 'modal-lg']); ?>
        <form wire:submit="update">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input wire:model='nombre' type="text" class="form-control" placeholder="Nombre tienda"
                        id="nombre">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="form-group col-md-7">
                    ...
                    <input wire:model='email' type="email" class="form-control" placeholder="Email tienda"
                        id="email">
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($this->imagen): ?>
                        <img src="<?php echo e($imagen->temporaryUrl()); ?>" class="rounded float-right" width="200">
...
<?php endif; ?>
<?php /**PATH /var/www/html/laravel/testapp/resources/views/livewire/shop/shop-component.blade.php ENDPATH**/ ?>