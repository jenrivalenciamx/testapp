...
<?php endif; ?></td>
                    ...
                    <td>
                        <a class="badge badge-secondary" href="<?php echo e(route('categories.show',$product->categorias->id)); ?>"><?php echo e($product->categorias->nombre); ?></a>
                    </td>
                    ...
                    <td>
                        <a href="#" wire:click='edit(<?php echo e($product->id); ?>)' class="btn btn-primary btn-xs" title="Editar">
                            <i class="fas fa-edit"></i>
                        </a>
                    </td>
                    <td>
                        <a wire:click="$dispatch('delete',{id: <?php echo e($product->id); ?>,eventName:'destroyProduct'})" class="btn btn-danger btn-xs" title="Eliminar">
...
<?php /**PATH /var/www/testapp/resources/views/livewire/product/product-component.blade.php ENDPATH**/ ?>