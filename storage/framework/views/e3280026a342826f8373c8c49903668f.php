...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['modalId' => 'modalProduct','modalTitle' => 'Productos','modalSize' => 'modal-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['modalId' => 'modalProduct','modalTitle' => 'Productos','modalSize' => 'modal-lg']); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-5">
                ...
                <select wire:model="categoria_id" id="categoria_id" class="form-control">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['precio_compra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['precio_venta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-4">
                ...
                <input wire:model='codigo_barras' type="text" class="form-control" placeholder="codigo de barras"
                    id="codigo_barras">
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['codigo_barras'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-4">
                ...
                <input wire:model='stock_minimo' min="0" type="number" class="form-control"
                    placeholder="stock minimo" id="stock_minimo">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="form-group col-md-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['activo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['item' => $product = App\Models\Productos::find($Id),'size' => '200','float' => 'float-right']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['item' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product = App\Models\Productos::find($Id)),'size' => '200','float' => 'float-right']); ?>
...
<?php endif; ?>
        ...
        <button wire:loading.attr='disabled'
            class="btn btn-primary float-right"><?php echo e($Id == 0 ? 'Guardar' : 'Editar'); ?></button>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/laravel/testapp/resources/views/productos/modal.blade.php ENDPATH**/ ?>