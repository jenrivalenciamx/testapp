...
<?php endif; ?>
        ...
        <button wire:loading.attr='disabled' class="btn btn-primary float-right"><?php echo e($Id==0 ? 'Guardar':'Editar'); ?></button>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?> <?php /**PATH /var/www/testapp/resources/views/productos/modal.blade.php ENDPATH**/ ?>