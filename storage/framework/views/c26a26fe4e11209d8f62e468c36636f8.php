                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><span
                                            class="badge badge-success"><?php echo e($product->stock_minimo); ?></span> </span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($product->categorias->name); ?></span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/laravel/testapp/resources/views/livewire/product/product-show.blade.php ENDPATH**/ ?>